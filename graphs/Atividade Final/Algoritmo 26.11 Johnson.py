...
def Dijkstra(G, novo_grafo, origem):
...
def BellmanFord(arestas, G, numero_vertices):
...
def johnson_algoritmo(G):
    ...
    pesos_modificados = BellmanFord(arestas, G, len(G))
